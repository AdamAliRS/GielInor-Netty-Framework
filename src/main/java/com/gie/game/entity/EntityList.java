...
public class EntityList<E extends Entity> implements Iterable<E> {
    ...
    /**
     * Gets the world object associated with a specific index.
     * @param index the index
     * @return The world object from the list.
    ...
    /**
     * Adds an world to the EntityList
     * @param entity the world to add
     ...
     * @param entity the world being checked.
     * @return whether the world is in the list.
     */
    ...
    /**
     * Removes a specific world from the list
     * @param entity The world to be removed
     * @return Whether the removal of the world was successful
     */
